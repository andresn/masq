(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else{ var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self }else { g = this }g.MasqStore = f() } })(function () { 
...
var init = exports.init = function init () {
  ...
  store.ready().then(function () {
    ...
    // Listen to online/offline events in order to trigger sync
      ...
      parameters.listener.postMessage({ 'cross-storage': 'listening' }, '*')

    log('Listening to clients...')
  }).catch(function (err) {
      log(err)
    try {
        parameters.listener.postMessage({ 'cross-storage': 'unavailable' }, '*')
      return;
      } catch (e) {
        log(e)
      return e
 ...
 */
  var registerApp = exports.registerApp = (function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(url) {
    var meta = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var origin, updatedMeta;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            origin = util.getOrigin(url);
            _context.next = 4;
            return store.exists(origin);
  ...
  return function registerApp(_x3) {
...
//   })
// }
}, {'./crypto': 1, './permissions': 3, './store': 4, './sync': 5, './util': 6, 'babel-runtime/helpers/asyncToGenerator': 10, 'babel-runtime/regenerator': 96}], 
...
}, {'./util': 6, 'babel-runtime/helpers/asyncToGenerator': 10, 'babel-runtime/regenerator': 96, 'localforage': 97}],
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.next = 4;
            return store.getMeta(msg.origin);
 ...
 */
  ...
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(msg, ws) {
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return store.exists(msg.origin);
          ...
          case 2:
            ...
            _context2.t1 = msg.updated !== undefined;
          ...
          case 5:
            ...
            _context2.t0 = !util.inTheFuture(msg.updated);
          ...
          case 16:
            if (!(meta.updated > 0 && msg.updated < meta.updated)) {
              _context2.next = 26;
              break;
            }

            _context2.t2 = msg.client;
            _context2.t3 = msg.origin;
            _context2.t4 = meta.updated;
            _context2.next = 22;
            return store.getAll(msg.origin);

          case 22:
            _context2.t5 = _context2.sent;
            _context2.t6 = {
              method: 'setAll',
              updated: _context2.t4,
              params: _context2.t5
            };
            resp = {
              type: 'sync',
 ...
 */
  ...
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(msg, ws) {
    var client = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';

    var apps, list, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, key, app, resp;
 ...
 */
  ...
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(msg, ws) {
    var client = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';

    var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, app, event;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.prev = 5;
            _iterator2 = msg.list[Symbol.iterator]();
          ...
          case 14:
            _context4.next = 16;
            return store.setAll(app.data.origin, {});
 ...
 */
  ...
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(ws) {
    var client = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    var list = arguments[2];
    var appList, i, meta, req;
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
 ...
 */
  var checkOne = exports.checkOne = (function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(ws) {
    var client = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
...
}, {'./crypto': 1, './store': 4, './util': 6, 'babel-runtime/helpers/asyncToGenerator': 10, 'babel-runtime/regenerator': 96}],
...
exports.dataToImg = exports.isLocal = exports.getOrigin = exports.isObject = exports.isEmpty = exports.inTheFuture = exports.now = undefined
 ...
 */
  var isObject = exports.isObject = function isObject (thing) {
    return (typeof thing === 'undefined' ? 'undefined' : (0, _typeof3.default)(thing)) === 'object'
};
...
}, {'core-js/library/fn/symbol': 13}],
 9: [function (require, module, exports) {
  module.exports = { 'default': require('core-js/library/fn/symbol/iterator'), __esModule: true }
}, {'core-js/library/fn/symbol/iterator': 14}],
...
}, {'../core-js/symbol': 8, '../core-js/symbol/iterator': 9}],
...
}, {'../modules/_core': 22, '../modules/es6.object.to-string': 87, '../modules/es6.promise': 88, '../modules/es6.string.iterator': 89, '../modules/es7.promise.finally': 91, '../modules/es7.promise.try': 92, '../modules/web.dom.iterable': 95}],
...
}, {'../../modules/_core': 22, '../../modules/es6.object.to-string': 87, '../../modules/es6.symbol': 90, '../../modules/es7.symbol.async-iterator': 93, '../../modules/es7.symbol.observable': 94}],
 14: [function (require, module, exports) {
  require('../../modules/es6.string.iterator')
require('../../modules/web.dom.iterable')
module.exports = require('../../modules/_wks-ext').f('iterator')

}, {'../../modules/_wks-ext': 83, '../../modules/es6.string.iterator': 89, '../../modules/web.dom.iterable': 95}],
...
}, {'./_to-absolute-index': 75, './_to-iobject': 77, './_to-length': 78}], 
...
}, {'./_object-gops': 58, './_object-keys': 61, './_object-pie': 62}], 
...
}, {'./_core': 22, './_ctx': 23, './_global': 32, './_hide': 34}],
...
}, {'./_an-object': 18, './_ctx': 23, './_is-array-iter': 39, './_iter-call': 42, './_to-length': 78, './core.get-iterator-method': 85}],
...
}, {'./_descriptors': 25, './_object-dp': 53, './_property-desc': 65}], 
...
}, {'./_descriptors': 25, './_dom-create': 26, './_fails': 30}],
...
}, {'./_hide': 34, './_object-create': 52, './_property-desc': 65, './_set-to-string-tag': 69, './_wks': 84}],
...
}, {'./_export': 29, './_has': 33, './_hide': 34, './_iter-create': 43, './_iterators': 47, './_library': 48, './_object-gpo': 59, './_redefine': 67, './_set-to-string-tag': 69, './_wks': 84}], 
...
}, {'./_fails': 30, './_has': 33, './_is-object': 41, './_object-dp': 53, './_uid': 81}],
...
}, {'./_an-object': 18, './_dom-create': 26, './_enum-bug-keys': 27, './_html': 35, './_object-dps': 54, './_shared-key': 70}], 
...
}, {'./_an-object': 18, './_descriptors': 25, './_ie8-dom-define': 36, './_to-primitive': 80}],
...
}, {'./_an-object': 18, './_descriptors': 25, './_object-dp': 53, './_object-keys': 61}],
...
}, {'./_descriptors': 25, './_has': 33, './_ie8-dom-define': 36, './_object-pie': 62, './_property-desc': 65, './_to-iobject': 77, './_to-primitive': 80}], 
...
}, {'./_object-gopn': 57, './_to-iobject': 77}], 
...
}, {'./_enum-bug-keys': 27, './_object-keys-internal': 60}],
...
}, {'./_has': 33, './_shared-key': 70, './_to-object': 79}], 
...
}, {'./_array-includes': 19, './_has': 33, './_shared-key': 70, './_to-iobject': 77}], 
...
}, {'./_an-object': 18, './_is-object': 41, './_new-promise-capability': 51}],
...
}, {'./_core': 22, './_descriptors': 25, './_global': 32, './_object-dp': 53, './_wks': 84}], 
...
}, {'./_a-function': 15, './_an-object': 18, './_wks': 84}], 
...
}, {'./_cof': 21, './_ctx': 23, './_dom-create': 26, './_global': 32, './_html': 35, './_invoke': 37}],
...
}, {'./_core': 22, './_global': 32, './_library': 48, './_object-dp': 53, './_wks-ext': 83}], 
...
}, {'./_classof': 20, './_core': 22, './_iterators': 47, './_wks': 84}],
...
}, {'./_add-to-unscopables': 16, './_iter-define': 44, './_iter-step': 46, './_iterators': 47, './_to-iobject': 77}], 
...
}, {'./_core': 22, './_export': 29, './_global': 32, './_promise-resolve': 64, './_species-constructor': 72}],
...
}, {'./_export': 29, './_new-promise-capability': 51, './_perform': 63}],
...
}, {'./_global': 32, './_hide': 34, './_iterators': 47, './_wks': 84, './es6.array.iterator': 86}],
 96: [function (require, module, exports) {
  module.exports = require('regenerator-runtime')

}, {'regenerator-runtime': 98}], 
