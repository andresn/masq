...
const Plusbutton = props => (
  ...
  >
    <defs>
      <circle id='plus-button-svg-a' cx={60} cy={60} r={60} />
      <path
        id='plus-button-svg-b'
    ...
    <g fill='none' fillRule='evenodd'>
      <use fill='#FFF' xlinkHref='#plus-button-svg-a' />
      <circle cx={60} cy={60} r={59} stroke='#CCC' strokeWidth={2} />
      <use fill='#CCC' fillRule='nonzero' xlinkHref='#plus-button-svg-b' />
    </g>
  </svg>
)
